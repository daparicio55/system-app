<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('administrador.medidas.index') }}" :active="request()->routeIs('administrador.medidas.index')">
                        {{ __('Medidas') }}
                    </x-nav-link>
                    ...
                    <x-nav-link href="{{ route('administrador.categorias.index') }}" :active="request()->routeIs('administrador.categorias.index')">
                        {{ __('Categorias') }}
                    </x-nav-link>

                    <x-nav-link href="{{ route('administrador.catalogos.index') }}" :active="request()->routeIs('administrador.catalogos.index')">
                        {{ __('Catalogos') }}
                    </x-nav-link>

                    <x-nav-link href="{{ route('administrador.compras.index') }}" :active="request()->routeIs('administrador.compras.index')">
                        {{ __('Compras') }}
                    </x-nav-link>

                    <x-nav-link href="{{ route('usuarios.ventas.index') }}" :active="request()->routeIs('usuarios.ventas.index')">
                        {{ __('Ventas') }}
                    </x-nav-link>
                    ...
                    {{-- <div class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link href="{{ route('administrador.medidas.index') }}">
                                    {{ __('Medidas') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('locales.index') }}" :active="request()->routeIs('locales.index')">
                {{ __('Locales') }}
            </x-responsive-nav-link>
