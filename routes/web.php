...
Route::middleware([
    ...
    Route::get('/usuarios/ventas', [UsuarioController::class, 'index'])->name('usuarios.ventas.index');

    Route::get('/usuarios/ventas/create', [UsuarioController::class, 'create'])->name('usuarios.ventas.create');
});
